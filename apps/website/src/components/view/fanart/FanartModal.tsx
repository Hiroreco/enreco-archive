...
const FanartModal = ({
    ...
    const handleScroll = useCallback(() => {
        ...
        const scrollTopCollapseThreshold = 20;

        const isScrollable =
            container.scrollHeight - scrollTopCollapseThreshold >
            container.clientHeight;
        const isAtTop = currentScrollTop <= scrollTopCollapseThreshold;
    ...
    return (
        <>
            <Dialog open={open} onOpenChange={onOpenChange}>
                <DialogContent className="max-w-7xl md:h-[90vh] h-[80vh] flex flex-col gap-4">
                    <div className="h-[95%] flex md:flex-row flex-col gap-2 md:gap-4">
                        <FanartFilters
                    ...
                    <div className="h-[5%] w-full flex flex-row justify-center">
                        <DialogClose asChild>
                            <Button className="bg-accent text-accent-foreground w-full md:w-[50%]">
