        ...
        <Drawer.Root direction={direction}>
            ...
            <Drawer.Portal>
                ...
                <Drawer.Content
                    data-testid="content"
                    className={clsx(
                        "bg-zinc-100 flex flex-col rounded-t-[10px] fixed ",
                        {
                            "bottom-0 mt-24 left-0 right-0 h-[96%]":
                                direction === "bottom",
                            "top-0 mb-24 left-0 right-0 h-[96%]":
                                direction === "top",
                            "left-0 top-0 bottom-0 w-[300px] h-full":
                                direction === "left",
                            "right-0 top-0 bottom-0 w-[300px] h-full":
                                direction === "right",
                        },
                    )}
                >
