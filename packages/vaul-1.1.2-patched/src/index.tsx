        ...
        if (isDragging) {
            ...
            if (isDraggingInDirection && !snapPoints) {
                ...
                const translateValue =
                    Math.min(dampenedDraggedDistance * -1, 0) *
                    directionMultiplier;
                set(drawerRef.current, {
